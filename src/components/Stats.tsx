    ...
    <div className='relative'>
      <div className='w-full max-w-screen-xl mx-auto px-4 sm:px-8 lg:px-16 grid grid-cols-1 lg:grid-cols-2 gap-y-12 pt-32'>
        <div className='lg:pr-16 overflow-hidden'>
          ...
          >
            ...
            <p className='mt-6 mb-3 max-w-xl font-light text-zinc-400'>
              Agentic AI is revolutionizing how we build and interact with software. By combining advanced machine learning, autonomous decision-making, and seamless integration, Agentic AI provides a robust foundation for creating intelligent, adaptive, and efficient systems.
            </p>
            <a href='/' className='flex items-start text-white'>
              <span className='font-light'>Learn more about Agentic AI</span>
              <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 11 14' className='fill-current h-3.5 mt-0.5 ml-0.5'>
        ...
        <div className='overflow-hidden'>
          ...
          >
            <h3 className='text-xl text-white'>Key Features of Agentic AI</h3>
            <a href='/' className='flex items-start text-white'>
              <span className='font-light'>Explore Agentic AI capabilities</span>
              <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 11 14' className='fill-current h-3.5 mt-0.5 ml-0.5'>
                <path d='M9.31328 2.625H9.75078V3.0625V9.1875V9.625H8.87578V9.1875V4.11797L1.96602 11.0277L1.65703 11.3367L1.03906 10.7187L1.34805 10.4098L8.25781 3.5H3.18828H2.75078V2.625H3.18828H9.31328Z'></path>
              </svg>
            </a>
            <motion.ul variants={wrapper} className='relative mt-6 space-y-3'>
              ...
              <motion.li variants={list} className='relative w-full'>
                <div className='absolute inset-0 bg-zinc-700 rounded-r-md' style={{ opacity: '100%', width: '100%' }}></div>
                <div className='relative items-center text-sm text-white px-2 w-full flex gap-4 h-6 whitespace-nowrap justify-between'>
                  <span>1. Autonomous Decision-Making</span>
                  <a href='/' className='flex items-center gap-1 text-white font-medium'>
                    <span>Docs</span>
                    <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 448 512' className='fill-current h-3.5 mt-0.5 ml-0.5'>
              ...
              <motion.li variants={list} className='relative w-full'>
                <div className='absolute inset-0 bg-zinc-700 rounded-r-md' style={{ opacity: '85%', width: '85%' }}></div>
                <div className='relative items-center text-sm text-white px-2 w-full flex gap-4 h-6 whitespace-nowrap justify-between'>
                  <span>2. Real-Time Adaptability</span>
                  <a href='/' className='flex items-center gap-1 text-white font-medium'>
                    <span>Docs</span>
                    <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 448 512' className='fill-current h-3.5 mt-0.5 ml-0.5'>
                      <path d='M429.8 273l17-17-17-17L276.2 85.4l-17-17-33.9 33.9 17 17L354.9 232 24 232 0 232l0 48 24 0 330.8 0L242.2 392.6l-17 17 33.9 33.9 17-17L429.8 273z'></path>
              ...
              <motion.li variants={list} className='relative w-full'>
                <div className='absolute inset-0 bg-zinc-700 rounded-r-md' style={{ opacity: '70%', width: '70%' }}></div>
                <div className='relative items-center text-sm text-white px-2 w-full flex gap-4 h-6 whitespace-nowrap justify-between'>
                  <span>3. Seamless Integration</span>
                  <a href='/' className='flex items-center gap-1 text-white font-medium'>
                    <span>Docs</span>
                    <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 448 512' className='fill-current h-3.5 mt-0.5 ml-0.5'>
                      <path d='M429.8 273l17-17-17-17L276.2 85.4l-17-17-33.9 33.9 17 17L354.9 232 24 232 0 232l0 48 24 0 330.8 0L242.2 392.6l-17 17 33.9 33.9 17-17L429.8 273z'></path>
              ...
              <motion.li variants={list} className='relative w-full'>
                <div className='absolute inset-0 bg-zinc-700 rounded-r-md' style={{ opacity: '55%', width: '55%' }}></div>
                <div className='relative items-center text-sm text-white px-2 w-full flex gap-4 h-6 whitespace-nowrap justify-between'>
                  <span>4. Predictive Analytics</span>
                  <a href='/' className='flex items-center gap-1 text-white font-medium'>
                    <span>Docs</span>
                    <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 448 512' className='fill-current h-3.5 mt-0.5 ml-0.5'>
                      <path d='M429.8 273l17-17-17-17L276.2 85.4l-17-17-33.9 33.9 17 17L354.9 232 24 232 0 232l0 48 24 0 330.8 0L242.2 392.6l-17 17 33.9 33.9 17-17L429.8 273z'></path>
              ...
              <motion.li variants={list} className='relative w-full'>
                <div className='absolute inset-0 bg-zinc-700 rounded-r-md' style={{ opacity: '40%', width: '40%' }}></div>
                <div className='relative items-center text-sm text-white px-2 w-full flex gap-4 h-6 whitespace-nowrap justify-between'>
                  <span>5. Natural Language Understanding</span>
                  <a href='/' className='flex items-center gap-1 text-white font-medium'>
                    <span>Docs</span>
                    <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 448 512' className='fill-current h-3.5 mt-0.5 ml-0.5'>
                      <path d='M429.8 273l17-17-17-17L276.2 85.4l-17-17-33.9 33.9 17 17L354.9 232 24 232 0 232l0 48 24 0 330.8 0L242.2 392.6l-17 17 33.9 33.9 17-17L429.8 273z'></path>
