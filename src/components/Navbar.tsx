  ...
  return (
    <div className='w-full max-w-screen-xl mx-auto px-4 sm:px-8 lg:px-16 pt-10 pb-5 flex items-center justify-between font-light text-zinc-300 sticky top-0 backdrop-blur-md z-20'>
      ...
      <LoadingBar
        ...
        <Link href={"/"}>
          <div className="flex items-center space-x-2">
            ...
            <p className="text-lg font-bold">Agentia World</p>
          </div>
        </Link>
      </div>
          ...
          <div className='h-8 bg-gradient-to-br from-zinc-600 to-zinc-900 rounded-lg focus:outline-none w-56'>
            <div className='flex items-center gap-2 pr-1 pl-3 bg-gradient-to-br from-zinc-800 to-zinc-950 h-full rounded-[7px]'>
              ...
              <div className='shrink-0 bg-gradient-to-b from-zinc-400 to-zinc-600 rounded'>
                <div className='bg-zinc-700 text-xs text-white px-1 py-0.5 rounded-[3px]'>⌘K</div>
              </div>
            </div>
          </div>
      ...
      <div className='md:hidden'>
        <button onClick={toggleMobileMenu} className="text-zinc-300 focus:outline-none">
          {isMobileMenuOpen ? <X className="h-6 w-6" /> : <Menu className="h-6 w-6" />}
        </button>
      </div>
      {isMobileMenuOpen && (
        <div className="md:hidden absolute top-20 right-4 bg-zinc-800 rounded-lg shadow-lg p-4">
          <div className="flex flex-col space-y-4">
            <a href="/" className="text-zinc-300 hover:text-purple-400">Technology</a>
            <a href="/" className="text-zinc-300 hover:text-purple-400">Pricing</a>
            <a href="/" className="text-zinc-300 hover:text-purple-400">Contact</a>
            <div className="flex items-center space-x-4">
              <a href="/" className="text-zinc-300 hover:text-purple-400">GitHub</a>
              <a href="/" className="text-zinc-300 hover:text-purple-400">Discord</a>
            </div>
          </div>
        </div>
      )}
